...
<body <?php body_class(); ?>>
    <header class="site-header">
        <div class="container">
            ...
            <a href="<?php echo site_url(); ?>"><strong>Unreal</strong> University</a>
            </h1>
            ...
            <nav class="main-navigation">
                <ul>
                    <li <?php if(is_page('about-us') || wp_get_post_parent_id(0) == 13) echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/about-us'); ?>">About Us</a></li>
